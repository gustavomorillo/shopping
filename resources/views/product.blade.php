							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="{{asset('images/'. $product->modal->image1)}}">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{asset('images/'. $product->modal->image1)}}">
					...
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<div class="flex-w flex-m p-l-100 p-t-40 respon7">
							<div class="flex-m bor9 p-r-10 m-r-11">
								<a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail tooltip100" data-id="{{$product->id}}" data-tooltip="Add to Wishlist">
