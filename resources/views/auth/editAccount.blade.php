                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateAccount') }}">
                        ...
                        <div class="form-group row py-2">
                            ...
                            <div class="col-md-6">
                                <input id="birthdate" type="text" class="form-control @error('birthdate') is-invalid @enderror" name="birthdate" value="{{Auth::user()->birthdate }}" required autocomplete="birthdate" autofocus>
